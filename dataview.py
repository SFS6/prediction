...
class ViewData:
    def __init__(self):
        ...
        def changepassword():
            ...
            cur2.execute(query)
            con.commit()
            messagebox.showinfo("Success", "Updated Success", parent=winland)
        ...
        winland.maxsize(width=1500, height=600)
        winland.minsize(width=1500, height=600)
        ...
        btn_login = Button(winland, text="Report", font='Verdana 10 bold', width="20", command=report)
        btn_login.place(x=1100, y=200)
        btn_login = Button(winland, text="Change password", font='Verdana 10 bold', command=changepassword)
